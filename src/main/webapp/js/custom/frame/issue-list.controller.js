(function () {
    ...
    IssueListController.$inject = ['$scope', 'CoverService', 'SweetAlert', 'NgTableParams', 'ngDialog', 'blockUI', 'Notify'];

    function IssueListController($scope, CoverService, SweetAlert, NgTableParams, ngDialog, blockUI, Notify) {
        ...
        $scope.publish = function () {
            ...
            var data = $scope.obj;
            CoverService.publishIssueList(data).success(function (data) {
                if (data.status == 200) {
